...
//    }
//
//    public static async Task<List<Customer>> GetStudents(string whereOption = "")
//    {
...
//        while (await reader.ReadAsync())
//        {
//            collection.Add(new Product(reader.GetInt32(0), await DBTools.GetGroups(reader.GetString(1)), reader.GetString(2), reader.GetString(3), reader.GetInt32(4)));
//        }
//
//        return collection;
//    }
